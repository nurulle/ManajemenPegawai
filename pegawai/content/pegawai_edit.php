...
<form method="post" action="?hal=pegawai_update" enctype="multipart/form-data">
   ...
   <div class="form-group">
      ...
      <div class="input">
         <input type="text" id="nama" name="nama" value="<?= $data['nama_pegawai'] ?>" required>
      </div> 
   </div>
   ...
   <div class="form-group">
      ...
      ?>
      <input type="radio" id="jk" name="jk" value="Laki-laki" <?= $l ?> > Laki-laki
      <input type="radio" id="jk" name="jk" value="Perempuan" <?= $p ?>> Perempuan
   </div>

   <div class="form-group">
      <label for="tanggal">Tanggal Lahir</label>   
      <div class="input">
         <input type="date" id="tanggal" name="tanggal" value="<?= $data['tgl_lahir'] ?>" required>
      </div>
   </div>
   ...
   <div class="form-group">
      ...
      <div class="input">
         <textarea required style="width: 100%" rows="5" id="keterangan" name="keterangan"><?= $data['keterangan'] ?></textarea>
      </div>
   </div>
