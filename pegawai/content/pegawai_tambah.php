...
<form method="post" action="?hal=pegawai_insert" enctype="multipart/form-data">
   ...
   <div class="form-group">
      ...
      <div class="input"><input type="file" id="foto" name="foto" required></div>
   </div>
   ...
   <div class="form-group">
      ...
      <div class="input"><input type="date" id="tanggal" name="tanggal" required></div>
   </div>
   ...
   <div class="form-group">
      ...
      <div class="input"><textarea style="width: 100%" rows="5" id="keterangan" name="keterangan" required ></textarea></div>
   </div>
